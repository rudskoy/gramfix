...
final class MLXServiceTests: XCTestCase {
    ...
    func testIsModelDownloadedUsesModelDirectoryMethod() async {
        ...
        XCTAssertTrue(modelDir.path.contains("Application Support/Gramfix/Models"),
                      "Model directory should be in Application Support/Gramfix/Models, got: \(modelDir.path)")
    }
